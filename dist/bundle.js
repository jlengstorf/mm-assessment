...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.buildJSXFromArray = buildJSXFromArray;
	exports.splitByLineBreaks = splitByLineBreaks;
	...
	function buildJSXFromArray(strArray) {
...
/***/ function(module, exports) {
	...
	var saveAnswer = exports.saveAnswer = function saveAnswer(id, value) {
	  return {
	    type: 'SAVE_ANSWER',
	    answer: {
	      id: id,
	...
	var saveMessages = exports.saveMessages = function saveMessages(messages) {
	  return {
	    type: 'SAVE_MESSAGES',
	    messages: messages
	  };
	...
	var saveQuestions = exports.saveQuestions = function saveQuestions(questions) {
	  return {
	    type: 'SAVE_QUESTIONS',
	    questions: questions
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AssessmentForm = __webpack_require__(100);

	var _AssessmentForm2 = _interopRequireDefault(_AssessmentForm);

	var _CalculatedScore = __webpack_require__(101);

	var _CalculatedScore2 = _interopRequireDefault(_CalculatedScore);
	...
	var App = function App() {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_AssessmentForm2.default, null),
	    _react2.default.createElement(_CalculatedScore2.default, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionContainer = __webpack_require__(103);
	...
	var Form = function Form(_ref) {
	  var _ref$questions = _ref.questions;
	  var questions = _ref$questions === undefined ? [] : _ref$questions;
	  var onQuestionsEmpty = _ref.onQuestionsEmpty;
	  ...
	  var classes = ['mm-assessment__questions'];
	  loading && classes.push('mm-assessment__questions--loading');

	  var questionComponents = questions.map(function (question) {
	    return _react2.default.createElement(_QuestionContainer2.default, _extends({ key: question.id }, question));
	  });
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'h2',
	      { className: 'mm-assessment__heading' },
	      'Website Assessment'
	    ),
	    _react2.default.createElement(
	      'p',
	      null,
	      'Fill out this assessment to see how well your website is communicating with the people who visit it.'
	    ),
	    _react2.default.createElement(
	      'form',
	      { className: 'mm-assessment__form mm-assessment__form--assessment' },
	      questionComponents
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = function Message(_ref) {
	  ...
	  var good = _ref$good === undefined ? [] : _ref$good;
	  var _ref$okay = _ref.okay;
	  var okay = _ref$okay === undefined ? [] : _ref$okay;
	  var _ref$bad = _ref.bad;
	  var bad = _ref$bad === undefined ? [] : _ref$bad;

	  var markup = '';

	  if (message && message.top) {
	    markup = ['<p>' + (0, _utils.splitByLineBreaks)(message.top).join('</p><p>') + '</p>', buildLinkMarkup(buildLinks(bad), message.badHeading), buildLinkMarkup(buildLinks(okay), message.okayHeading), buildLinkMarkup(buildLinks(good), message.goodHeading), '<p>' + (0, _utils.splitByLineBreaks)(message.bottom).join('</p><p>') + '</p>'].join('');
	  }

	  var encodedMarkup = utf8_to_b64(markup);

	  return _react2.default.createElement('input', { type: 'hidden', name: 'rmsg', value: encodedMarkup });
	};
	...
	var buildLinks = function buildLinks(links) {
	  return links.toArray().map(function (_ref2) {
	...
	var buildLinkMarkup = function buildLinkMarkup(links, message) {
	  var markup = [];
	  if (links.length > 0) {
	    markup = ['<p><strong>' + message + '</strong></p>', '<ul>' + links.join('') + '</ul>'];
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionAnswer = __webpack_require__(102);
	...
	var Question = function Question(_ref) {
	  ...
	  var description = _ref$description === undefined ? false : _ref$description;
	  var answers = _ref.answers;
	  var isAnswered = _ref.isAnswered;

	  var answerComponents = answers.map(function (answer) {
	    return _react2.default.createElement(_QuestionAnswer2.default, _extends({ key: answer.id, name: id }, answer));
	  });

	  var classes = ['mm-assessment__input-group', 'mm-assessment__input-group--question', 'mm-question'];
	  if (isAnswered) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'h3',
	      { className: 'mm-question__heading' },
	      question
	    ),
	    description && _react2.default.createElement(
	      'p',
	      { className: 'mm-question__description' },
	      description
	    ),
	    _react2.default.createElement(
	      'ul',
	      { className: 'mm-question__radio-group' },
	      answerComponents
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionOption = function QuestionOption(_ref) {
	  var name = _ref.name;
	  var id = _ref.id;
	  ...
	  return _react2.default.createElement(
	    "li",
	    { className: "mm-question__radio-item" },
	    _react2.default.createElement("input", { className: "mm-question__input mm-question__input--radio",
	      id: name + "_" + id,
	      name: name,
	      type: "radio",
	      value: value,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResourceMessage = __webpack_require__(104);

	var _ResourceMessage2 = _interopRequireDefault(_ResourceMessage);
	...
	var Results = function Results(_ref) {
	  ...
	  var _ref$currentResults = _ref.currentResults;
	  var currentResults = _ref$currentResults === undefined ? 0 : _ref$currentResults;
	  var onMessagesEmpty = _ref.onMessagesEmpty;
	  ...
	  var messageData = getMessageData(messages, currentResults);
	  var image = { loaded: false };
	  var email = { loaded: false };
	  ...
	  var classes = ['mm-assessment__results'];
	  ...
	  return _react2.default.createElement(
	    ...
	    !loading && _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'strong',
	          { className: 'mm-assessment__grade' },
	          'Score: ',
	          currentResults,
	          '%'
	        ),
	      ...
	      _react2.default.createElement(
	        'h3',
	        { className: 'mm-assessment__sub-heading' },
	        messageData.subheading
	      ),
	      image && image.src && _react2.default.createElement(
	        'figure',
	        { className: 'mm-assessment__image-wrap' },
	        _react2.default.createElement('img', { src: image.src, alt: image.alt, className: 'mm-assessment__image' }),
	        _react2.default.createElement(
	          'figcaption',
	          { className: 'mm-assessment__image-caption' },
	          image.caption || image.alt,
	          image.credit && _react2.default.createElement(
	            'span',
	            { className: 'mm-assessment__image-credit' },
	            _react2.default.createElement(CreditLink, {
	              credit: image.credit,
	      ...
	      _react2.default.createElement(
	        'div',
	        { 'class': 'mm-assessment__description' },
	        (0, _utils.buildJSXFromArray)((0, _utils.splitByLineBreaks)(messageData.message))
	      )
	    ),
	    _react2.default.createElement(
	      'form',
	      { className: 'mm-assessment__form', action: './', method: 'post' },
	      _react2.default.createElement(
	        'div',
	        { className: 'mm-assessment__input-group' },
	        _react2.default.createElement(
	          'label',
	          { className: 'mm-assessment__label', htmlFor: 'fname' },
	          'First Name'
	        ),
	        _react2.default.createElement('input', { className: 'mm-assessment__input mm-assessment__input--text',
	          type: 'text',
	          name: 'fname',
	          id: 'fname'
	        })
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'mm-assessment__label', htmlFor: 'email' },
	          'Email Address'
	        ),
	        _react2.default.createElement('input', { className: 'mm-assessment__input mm-assessment__input--email',
	          type: 'email',
	          name: 'email',
	          id: 'email'
	        })
	      ),
	      _react2.default.createElement('input', { className: 'mm-assessment__button',
	        type: 'submit',
	        value: 'Send My Report'
	      }),
	      _react2.default.createElement(_ResourceMessage2.default, { message: email })
	    )
	  );
	};

	var CreditLink = function CreditLink(_ref2) {
	  var credit = _ref2.credit;
	  var creditLink = _ref2.creditLink;

	  var imageCredit = _react2.default.createElement(
	    'span',
	    { className: 'mm-assessment__credit' },
	    credit
	  );

	  if (creditLink) {
	    imageCredit = _react2.default.createElement(
	      'a',
	      { className: 'mm-assessment__credit mm-assessment__credit--link',
	        href: creditLink },
	      credit
	    );
	  }
	...
	var getMessageData = function getMessageData(messages, score) {
	  if (messages.length < 1) {
	    return false;
	  }
	...
	var OgetMessageData = function OgetMessageData(score) {
	  if (score === 10) {
	    return {
	      heading: 'Perfect!',
	      ...
	      message: _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'But just in case you’d like to brush up on all the ways you’re doing things right, I’ve put together a refresher course for you.'
	        )
	      )
	    };
	  }
	    ...
	    return {
	      ...
	      message: _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'But don’t worry: fixing the issues with your site may not be as hard as you think.'
	        )
	      )
	    };
	  }
	    ...
	    return {
	      ...
	      message: _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'Okay, I’m not going to sugar-coat it: your site needs work. There’s  a good chance your site visitors are frustrated, confused, and closing your site before they ever learn how you can help them. ¡No bueno!'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onQuestionsEmpty: function onQuestionsEmpty() {
	      // TODO set this in props or, better, and env var
	      (0, _utils.getDataFromApi)(window.MM_WP_API_URL + '/acf/options/questions').then(function (response) {
	        dispatch((0, _actions.saveQuestions)(response));
	      });
	    }
	  };
	};

	var AssessmentForm = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Form2.default);

		exports.default = AssessmentForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
	  var currentScore = state.answers.reduce(function (a, b) {
	    return parseInt(a) + parseInt(b);
	  }) || 0;
	  var highScore = state.questions.length * 2;
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onMessagesEmpty: function onMessagesEmpty() {
	      (0, _utils.getDataFromApi)(window.MM_WP_API_URL + '/acf/options/messages').then(function (response) {
	        dispatch((0, _actions.saveMessages)(response));
	      });
	    }
	  };
	};

	var CalculatedScore = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Results2.default);

		exports.default = CalculatedScore;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionOption = __webpack_require__(98);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onChangeHandler: function onChangeHandler(event) {
	      ...
	      dispatch((0, _actions.saveAnswer)(input.name, input.value));
	    }
	  };
	};

	var QuestionAnswer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_QuestionOption2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Question = __webpack_require__(97);
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
	  return {
	    isAnswered: !!state.answers.filter(function (q, id) {
	      return id === ownProps.id;
	    }).size
	  };
	};

	var QuestionContainer = (0, _reactRedux.connect)(mapStateToProps)(_Question2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
	  var filterAnswers = filterByIntVal.bind(null, state.answers);
	  var addResources = mapResources.bind(null, state.questions);
	...
	var filterByIntVal = function filterByIntVal(answers, matchValue) {
	  return answers.filter(function (value) {
	    return parseInt(value) === matchValue;
	  });
	};

	var mapResources = function mapResources(questions, answers) {
	  return answers.map(function (value, key) {
	    return {
	      value: value,
	      resource: questions.filter(function (q) {
	        return q.id === key;
	      }).pop().resource
	    };
	  });
	...
	var ResourceMessage = (0, _reactRedux.connect)(mapStateToProps)(_Message2.default);

		exports.default = ResourceMessage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questions = __webpack_require__(109);

	var _questions2 = _interopRequireDefault(_questions);

	var _answers = __webpack_require__(106);

	var _answers2 = _interopRequireDefault(_answers);

	var _messages = __webpack_require__(108);

	var _messages2 = _interopRequireDefault(_messages);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var assessment = (0, _redux.combineReducers)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(157);
	var warning = __webpack_require__(2);
